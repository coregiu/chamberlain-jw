...
public class ChinaCalendar extends JFrame implements ActionListener {

	private static final long serialVersionUID = 1L;

	public static void main(String[] args) {

		SwingConsole.run(new ChinaCalendar(), 525, 525);
	}
	...
	class LookAndFeel_Listener implements ActionListener {// 选择外观的样式
		public void actionPerformed(ActionEvent ev) {
			...
			SwingUtilities.updateComponentTreeUI(ChinaCalendar.this);
		}
	...
	class Statement_Listener implements ActionListener {// 显示声明信息
		...
		public void actionPerformed(ActionEvent ev) {
			...
			dialog = new JDialog(ChinaCalendar.this, "阴历及节日软件 2008 beta1", true);
	...
	class List_MouseListener implements MouseListener {// 鼠标移入时显示的信息
		...
		public String constellation(Calendar cal) {
			...
			if ((Integer.parseInt(str) >= Integer.parseInt(con[11][1]) && Integer
					.parseInt(str) < 1232)
