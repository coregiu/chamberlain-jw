...
public class IAddInfoDialog extends JDialog implements ActionListener, KeyListener, MouseListener{
	private static final long serialVersionUID = 1L;
	private IOConfAction ioConfAction = new IOConfAction();
	
	private JLabel label_0=new JLabel("添加收入信息",JLabel.CENTER);
	...
	public IAddInfoDialog(JFrame _f){
		super(_f, "添加收入信息", true);
	...
	private JComponent body(){
        ...
        txt_7.setText((new SimpleDateFormat("yyyy-MM-dd HH:mm:00")).format(new Date()));
	...
	public void actionPerformed(ActionEvent event){
		if("add".equals(event.getActionCommand())){
			...
			if(ioConfAction.addIInfo(ioDataBean)){
				ConfBean.loadIOInfo();
