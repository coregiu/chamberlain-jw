...
public class OAddInfoDialog extends JDialog implements ActionListener, KeyListener, MouseListener{
	private static final long serialVersionUID = 1L;
	private IOConfAction ioConfAction = new IOConfAction();
	
	private JLabel label_0=new JLabel("添加支出信息",JLabel.CENTER);
	...
	public OAddInfoDialog(JFrame _f){
		super(_f, "添加支出信息", true);
	...
	private JComponent body(){
        ...
        JPanel panelAdd=new JPanel(new GridLayout(9,2,1,1));
	...
	public void actionPerformed(ActionEvent event){
		if("add".equals(event.getActionCommand())){
			...
			if(ioConfAction.addOInfo(ioDataBean)){
				ConfBean.loadIOInfo();
