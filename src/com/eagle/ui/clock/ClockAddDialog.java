...
public class ClockAddDialog extends JDialog implements ActionListener, KeyListener, MouseListener{
	private static final long serialVersionUID = 1L;
	private ClockAction clkAction = new ClockAction();
	private DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
	
	private JPanel clkPanle ;
	private JLabel label_0=new JLabel("添加闹钟配置",JLabel.CENTER);
	...
	public ClockAddDialog(JFrame _f){
		super(_f, "添加闹钟配置", true);
