...
public class PlainUpdatePanel extends JDialog implements ActionListener, KeyListener, MouseListener{
	private static final long serialVersionUID = 1L;
	private PlainAction plainAction = new PlainAction();
	
	private JLabel label_0=new JLabel("查询修改工作学习计划",JLabel.CENTER);
    ...
    private JLabel label_4=new JLabel("是否完成：",JLabel.CENTER);
	...
	public PlainUpdatePanel(JFrame _f, PlainData plainData){
		super(_f, "查询修改工作学习计划", true);
	...
	private void body(){
        ...
        txt_1.setText(plainData.getCurrentPlainData().getId());
        txt_2.setText(plainData.getCurrentPlainData().getTitle());
        txt_3.setText(plainData.getCurrentPlainData().getContent());
        txt_4.setSelectedItem(plainData.getCurrentPlainData().getCompleted());
        ...
        panel_2.setBounds(10,75,380,30);
        panel_3.setBounds(10,105,380,30);
        panel_4.setBounds(10,135,380,270);
        panel_6.setBounds(10,405,380,30);
        panel_8.setBounds(10,435,380,30);
        plnMain.add(panel_1);
        plnMain.add(panel_2);
        plnMain.add(panel_3);
        plnMain.add(panel_4);
	...
	public void actionPerformed(ActionEvent event){
		if("add".equals(event.getActionCommand())){
			...
			plainData.setCompleted(txt_4.getSelectedItem().toString());
			this.plainData.setCurrentPlainData(plainData);
			
			if(plainAction.updatePlain(plainData)){
				log.info("修改成功");
